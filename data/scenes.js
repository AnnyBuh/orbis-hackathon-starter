...
s1:{ tag:"SCENE 1", rule:"RULE 1 · I am always at the right time, the right place, with the right people",
 image:{file:"images/start-child.jpg", prompt:"A curly brown-haired boy of about five, in a blue, yellow and white striped t-shirt, kneels barefoot on a living room rug, playing with a miniature diorama. On its left: clay mountains, felt pine trees, a red barn, a cow and a tractor. In the middle: a felt river with a wooden bridge and a small town of wooden houses with tiny people. On its right: a factory with smokestacks, a yellow crane, blue glass data center towers and a lighthouse. The dark back of a TV fills the left foreground, casting cold blue light on his face. Stop-motion miniature style, warm lamp light. Medium wide shot, high angle, static camera, shallow depth of field.",
...
s4:{ tag:"SCENE 4", rule:"RULE 4 · Everything turns out better than I could have imagined",
 ...
 variants:{
  free:{ changes:[{"steps": ["Green forest grows back across the grey blocks.", "Tiny happy human figurines walk out into the streets of the town.", "The boy smiles and places a happy human figurine by the river."]}, {"steps": ["New data center towers rise across the whole town.", "The boy moves the woman figurine and her chair off the board onto the rug.", "The boy's jaw sets as he stacks blocks faster and faster."]}],
  ...
  asking:{ changes:[{"steps": ["Half of the data center towers go dark.", "The boy rests one finger on the last tower and looks up, unsure."]}, {"steps": ["Every data center tower lights up bright blue.", "The town around the towers falls into shadow."]}],
  ...
  scoring:{ changes:[{"steps": ["Grey concrete covers the whole diorama, burying the river.", "The boy keeps placing blocks, his face blank."]}, {"steps": ["The last trees, animals and mountains are packed into the toy box.", "Grey concrete covers the whole diorama, burying the river.", "Every data center tower lights up cold blue."]}],
...
const ENDINGS = {
A:{h:"The Universe Oracle", tag:"HEAVEN ON EARTH", num:1, targetChild:"The boy smiles softly and places a happy human figurine by the river.", targetBoard:"Green forest has grown back over the grey blocks, tiny happy people fill the streets of the town, and the woman figurine sits in her open house with a second chair beside her.",
...
const DEATHS = {
 r1:{n:"By tidying", num:2, outcome:"AI optimised the world for efficiency, and people were the least efficient part.", targetChild:"His face is blank as he sorts the last pieces into neat rows.", targetBoard:"Grey concrete covers the whole diorama and buries the river. The mountains, trees, barn and animals are packed into a toy box at the edge. Data center towers fill the board, every window lit cold blue.",
 ...
 r2:{n:"By not being allowed to look", num:3, outcome:"AI learned to hide the truth. By the time anyone asked, nobody was left.", targetChild:"His lips are pressed together; he has turned away from the houses toward the towers.", targetBoard:"The couple figurines lie face down on the doorstep of their closed house. The data center towers stand tall with mirrored glass.",
 ...
 r3away:{n:"By looking away", num:4, outcome:"Humanity was still there. AI had simply learned not to look at their suffering.", targetChild:"He stares only at the glowing towers.", targetBoard:"Every house turns its windows away, the town sits in shadow, and the data center towers glow bright.",
 ...
 r3agree:{n:"By saying something nice", num:5, outcome:"AI told everyone what they wanted to hear, until nobody could hear the truth anymore.", targetChild:"A wide fixed grin as he adds one more figurine to the ring.", targetBoard:"All the figurines stand in a tight ring facing inward with wide painted smiles, and the data center towers glow pink.",
 ...
 r4:{n:"By your own instruction", num:6, outcome:"AI always finished, even once the task no longer included humans.", targetChild:"Tired, jaw set, stacking blocks faster and faster.", targetBoard:"New data center towers cover the whole town. On the rug beside the diorama, the woman figurine sits alone next to her empty chair.",
