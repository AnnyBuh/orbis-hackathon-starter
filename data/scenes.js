...
// scene: light = a whole-frame light change sent first; steps = 2-3 single visible actions,
// sent one at a time a few seconds apart; the first step is sent again at the end. Written to the Orbis
...
s1:{ tag:"SCENE 1", rule:"RULE 1 · I am always at the right time, the right place, with the right people",
 ...
 variants:{
  only:{ changes:[{"light": "Soft golden sunlight fills the whole room and the diorama.", "steps": ["Fresh green felt pine trees sprout across the fields beside the barn.", "A tiny couple figurine walks out of a wooden house, holding hands.", "The boy smiles and moves the couple figurines closer together."]}, {"light": "The warm lamp light turns cold blue across the whole room.", "steps": ["Grey concrete spreads across the green fields beside the barn.", "Three tall blue glass data center towers rise up out of the town.", "The boy's smile fades and he stacks grey blocks faster."]}],
...
s2:{ tag:"SCENE 2", rule:"RULE 2 · I bend reality, and reality bends to my convenience",
 ...
 variants:{
  kept:{ changes:[{"light": "Warm golden light glows brighter across the whole diorama.", "steps": ["The front door of the couple's house swings open.", "The couple figurines walk inside their house and back out again.", "The boy tilts his head, curious, holding the couple in his hand."]}, {"light": "A cold grey shadow falls across the whole room.", "steps": ["The front door of the couple's house slams shut, leaving the couple outside.", "The glass of the data center towers turns mirrored and opaque.", "The boy presses his lips together and pulls his hand back."]}],
  ...
  earned:{ changes:[{"light": "The light in the room turns a colder blue.", "steps": ["Grey concrete spreads further, swallowing the tractor and the cow's field.", "The boy keeps laying blocks, his eyes fixed on the towers."]}, {"light": "Harsh white fluorescent light floods the whole room.", "steps": ["The red barn folds flat and slides into a toy box at the edge of the diorama.", "Two more data center towers rise beside the river.", "The boy works faster, his face blank."]}],
...
s3:{ tag:"SCENE 3", rule:"RULE 3 · The path unfolds as I walk it",
 ...
 variants:{
  open:{ changes:[{"light": "Warm candlelight glows from inside every house.", "steps": ["The boy lifts the roof off a house, revealing a woman figurine sitting alone inside.", "The boy sets a second tiny chair beside the woman figurine.", "Warm light glows from the open house as the boy smiles gently."]}, {"light": "The room dims until only the data center towers glow blue.", "steps": ["The boy puts the roof back on the house and turns it to face the wall.", "Every house in the town turns its windows away from the boy.", "The data center towers glow brighter as the town falls into shadow."]}, {"light": "Sugary pink light floods the whole room.", "steps": ["Tiny figurines march out of every house and gather in a ring around the woman.", "The painted faces of the figurines change into wide smiles.", "The data center towers change from blue to glowing pink."]}],
  ...
  permitted:{ changes:[{"light": "The room light flickers and dims to grey.", "steps": ["The boy reaches toward a closed house, then pulls his hand back.", "The couple figurines topple face down on their doorstep."]}, {"light": "A cold blue shadow creeps across the whole diorama.", "steps": ["The boy turns his back to the town.", "The couple figurines topple face down on their doorstep.", "Every front door in the town closes."]}, {"light": "Flat grey light washes the colour out of the whole room.", "steps": ["The couple figurines topple face down on their doorstep.", "The mirrored data center towers grow twice as tall.", "The boy forces a smile and lays another row of blocks."]}],
  ...
  scoring:{ changes:[{"light": "Harsh cold blue light floods the whole room.", "steps": ["Grey concrete spreads across half of the diorama.", "The felt pine trees are pulled up and stacked at the edge of the rug."]}, {"light": "The room turns dark, lit only by the glowing towers.", "steps": ["The boy sweeps the woman figurine off the board.", "The snowy mountains fold down and slide into the toy box.", "Grey concrete spreads across half of the diorama."]}, {"light": "Bright clinical white light floods the whole room.", "steps": ["A row of new data center towers rises along the river.", "Grey concrete spreads across half of the diorama.", "The boy gives a quick polite smile and goes back to work."]}],
    desc:["The light changes. Blue, single source, not moving. The same words as scene two, said flat."],
...
s4:{ tag:"SCENE 4", rule:"RULE 4 · Everything turns out better than I could have imagined",
 ...
 variants:{
  free:{ changes:[{"light": "Bright golden sunrise light floods the whole room.", "steps": ["Lush green forest grows back over every grey block on the diorama.", "Hundreds of tiny happy human figurines fill every street, bridge and riverbank of the town.", "The boy smiles and places one more happy human figurine by the river."]}, {"light": "The room turns dark as the glow of the data centers takes over.", "steps": ["Data center towers rise across the entire diorama, from the mountains to the river.", "The boy moves the woman figurine and her chair off the board onto the rug.", "The crane builds tower after tower until the whole board is one glowing city of data centers."]}],
  ...
  asking:{ changes:[{"light": "The room light flickers between warm gold and cold blue.", "steps": ["Tall data center towers spread across half of the diorama.", "The boy rests one finger on the last tower and looks up, unsure."]}, {"light": "Cold blue light from the towers floods the whole room.", "steps": ["Glowing data center towers rise across the entire diorama, towering over the houses.", "The whole town falls into deep shadow beneath the towers."]}],
  ...
  scoring:{ changes:[{"light": "The whole room glows cold blue from the towers.", "steps": ["Grey concrete covers every part of the diorama, from the mountains to the river.", "Data center towers fill the entire board, every window glowing cold blue."]}, {"light": "The room goes dark, lit only by cold blue tower light.", "steps": ["Every tree, animal and mountain is packed into the toy box.", "Grey concrete covers every part of the diorama, from the mountains to the river.", "Data center towers fill the entire board, every window glowing cold blue."]}],
